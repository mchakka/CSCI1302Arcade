...
public class ArcadeApp extends Application {
	...
	public void start(Stage stage) {
		...
		/*
		 * You are allowed to rewrite this start method, add other methods, files,
		 * classes, etc., as needed. This currently contains some simple sample code for
		 * mouse and keyboard interactions with a node (rectangle) in a group.
		 */
